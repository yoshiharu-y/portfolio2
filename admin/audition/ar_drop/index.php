...
{
	if(!empty($_POST["artist_drop"]))
	{
		//画面指定
		define("FILENAME","ar_drop");
	}
	else if(!empty($_POST["ar_drop_comp"]))
	{
		if(!empty($_POST["ar_drop_check"]) && empty($_POST["no_ar"]))
		{
			//画面指定
			define("FILENAME","ar_drop_complate");		
		}
		else
		{
			//画面指定
