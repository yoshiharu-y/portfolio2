...
$sql = "SELECT ar_movie.movie_title,ar_movie.movie_url,ar_movie.movie_type,ar_movie.ar_id,ar_movie.reg_date,ar_movie.renew_date,artist.artist_name 
		FROM ar_movie INNER JOIN artist ON ar_movie.ar_id=artist.ar_id
		WHERE ar_movie.ar_id=".$_POST["artist_no"];
