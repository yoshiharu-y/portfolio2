...
$_SESSION["mn_movie_create"]=$_POST;

//エラーが無い場合の処理
if( $row["err_det"]=="")
{
	if(!empty($_POST["mn_movie_create_comp"]))
	{
	...
	$row["comp_btn"]='<input type="submit" name="mn_movie_create_comp" value="新規動画投稿を完了する" class="formBtn" />';
}
else
{
	 $row["comp_check"]="";
