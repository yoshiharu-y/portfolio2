...
if(!empty($_POST["comp_check"])&&!empty($_POST["movie_create_comp"]))
{
	$row["err_det"]="";
	
	//記事の日時を生成
	$_SESSION["movie_create"]["reg_date"]= date("Y-m-d");
	$_SESSION["movie_create"]["renew_date"]= date("Y-m-d");
	//配列のキーを変数名とした変数を作る
	extract($_SESSION["movie_create"]);
	//sql文作成
