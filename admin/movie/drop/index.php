...
if($_SESSION["mms_admin_login"])
{
	...
	else if(!empty($_POST["drop_comp"]))
	{
		...
		{
			//画面指定
			define("FILENAME","movie_drop_complate");		
		}
		else
		{
			//画面指定
	...
	else if(!empty($_POST["mn_drop"]))
	{
		//画面指定
		define("FILENAME","mn_movie_drop");
	}
	else if(!empty($_POST["mn_drop_comp"]))
	{
		if(!empty($_POST["drop_check"]))
		{
			//画面指定
			define("FILENAME","mn_movie_drop_complate");		
		}
		else
		{
			//画面指定
